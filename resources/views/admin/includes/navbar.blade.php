  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
        <a href="#" class="d-block">ALL-IN-ONE Admin</a>
        </div>
      </div>
            ...
            <li class="nav-item">
              ...
              <li class="nav-item has-treeview ">
                ...
                <ul class="nav nav-treeview">
                  <li class="nav-item">
                    <a href="{{ url('admin/'.Illuminate\Support\Str::plural($table->name).'/create')  }}" class="nav-link">
                      <i class="far fa-circle nav-icon"></i>
                      <p>Create New </p>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a href="{{ url('admin/'.Illuminate\Support\Str::plural($table->name).'/')  }}" class="nav-link">
                      <i class="far fa-circle nav-icon"></i>
                      <p>View All</p>
                    </a>
                  </li>
